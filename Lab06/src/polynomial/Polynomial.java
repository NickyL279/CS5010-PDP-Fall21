...
/**
 * This interface represents all the operations offered by a polynomial. A polynomial is defined
 * here as a function of one variable. The polynomial is a weighted sum of terms (the weights are
 * numeric). Each term may either be an integer power of that variable, or some function in that
 * variable, but never both (i.e. (log x)^2 is not allowed).
 */
